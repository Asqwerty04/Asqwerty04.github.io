...
Жестокий век.__name__ = true;
Жестокий век.prototype = {
    f_sort: function(x, y) {
    ...
    removeBookmark: function(pageNum) {
        ...
        while (_g1 < _g) {
            ...
            haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum, {
                fileName: "Жестокий век.hx",
                lineNumber: 2028,
                className: "Жестокий век",
    ...
    onEmailClick: function(e) {
        ...
        this.setTopTitle("ShareThisЖестокий век");
        if (RunTime.contentInfo != null) {
    ...
    turnToPage: function(pageNum) {
        ...
        this.hideTopBar();
        RunTime.Жестокий век.rightPageLock.style.display = "none";
        RunTime.Жестокий век.leftPageLock.style.display = "none";
        if (page != null && page.locked && RunTime.bLocked) RunTime.Жестокий век.leftPageLock.style.display = "block";
        this.clearSlideshow();
    ...
    turnPage: function(pageOffset) {
        ...
        this.tweener.onChange = function(count) {
            ...
            if (count == maxCount) {
                ...
                RunTime.Жестокий век.rightPageLock.style.display = "none";
                RunTime.Жестокий век.leftPageLock.style.display = "none";
                if (dstPage != null && dstPage.locked && RunTime.bLocked) RunTime.Жестокий век.leftPageLock.style.display = "block";
...
//      this.maskGesture.target = eval("document.getElementById('mask')");
    ...
    __class__: Жестокий век
}
var DoubleЖестокий век=function(){this.mainAdLayout="center";this.mainAdDockPos="halfpage";Жестокий век.call(this)};
DoubleЖестокий век.__name__ = true;
DoubleЖестокий век.__super__ = Жестокий век;
DoubleЖестокий век.prototype = $extend(Жестокий век.prototype, {
    loadCtxNotes: function() {
    ...
    turnToPage: function(pageNum) {
        ...
        this.tweener.onChange = function(count) {
            ...
            if (count == maxCount) {
                ...
                RunTime.Жестокий век.rightPageLock.style.display = "none";
                RunTime.Жестокий век.leftPageLock.style.display = "none";
                if (newPair.rightPage != null && newPair.rightPage.locked && RunTime.bLocked) RunTime.Жестокий век.rightPageLock.style.display = "block";
                if (newPair.leftPage != null && newPair.leftPage.locked && RunTime.bLocked) RunTime.Жестокий век.leftPageLock.style.display = "block"
            }
            self.bookContext.render();
            _g.updateAds()
        };
    ...
    loadPage: function(index) {
        ...
        if (p.rightPage != null && p.rightPage.locked && RunTime.bLocked) RunTime.Жестокий век.rightPageLock.style.display = "block";
        if (p.leftPage != null && p.leftPage.locked && RunTime.bLocked) RunTime.Жестокий век.leftPageLock.style.display = "block";
        this.bookContext.render();
...
RunTime.loadState = function() {
    ...
    if (bbv == true) RunTime.Жестокий век.showBottomBar();
    else RunTime.Жестокий век.hideBottomBar(null, false)
}
...
RunTime.preRequestBookInfo = function() {
    ...
    function(data) {
        ...
        if (RunTime.book.singlepageMode) {
            RunTime.Жестокий век = new Жестокий век();
            RunTime.singlePage = true
        } else if (RunTime.clientHeight > RunTime.clientWidth) {
            RunTime.Жестокий век = new Жестокий век();
            RunTime.singlePage = true
        } else {
            RunTime.Жестокий век = new DoubleЖестокий век();
            RunTime.singlePage = false
        }
        RunTime.Жестокий век.zoom = js.Lib.document.getElementById("zoom");
        var bookleftpage = js.Lib.document.getElementById("leftpage");
        RunTime.Жестокий век.zoomLeftPage = bookleftpage;
        var bookrightpage = js.Lib.document.getElementById("rightpage");
        RunTime.Жестокий век.zoomRightPage = bookrightpage;
        ...
        RunTime.Жестокий век.leftPageLock = leftPageLock;
        RunTime.Жестокий век.rightPageLock = rightPageLock;
        ...
        RunTime.Жестокий век.leftLockIcon = leftLockIcon;
        RunTime.Жестокий век.rightLockIcon = rightLockIcon;
        RunTime.Жестокий век.root = js.Lib.document.getElementById("cvsBook");
        RunTime.Жестокий век.mask = js.Lib.document.getElementById("mask");
        RunTime.Жестокий век.tbPageCount = js.Lib.document.getElementById("tbPageCount");
        RunTime.Жестокий век.tbPage = js.Lib.document.getElementById("tbPage");
        RunTime.Жестокий век.btnContents = js.Lib.document.getElementById("btnContents");
        RunTime.Жестокий век.btnThumbs = js.Lib.document.getElementById("btnThumbs");
        RunTime.Жестокий век.btnSearch = js.Lib.document.getElementById("btnSearch");
        RunTime.Жестокий век.btnMask = js.Lib.document.getElementById("btnMask");
        RunTime.Жестокий век.btnBookMark = js.Lib.document.getElementById("btnBookMark");
        RunTime.Жестокий век.btnNote = js.Lib.document.getElementById("btnNote");
        RunTime.Жестокий век.btnPrevPage = js.Lib.document.getElementById("btnPrevPage");
        RunTime.Жестокий век.btnNextPage = js.Lib.document.getElementById("btnNextPage");
        RunTime.Жестокий век.btnFirstPage = js.Lib.document.getElementById("btnFirstPage");
        RunTime.Жестокий век.btnLastPage = js.Lib.document.getElementById("btnLastPage");
        RunTime.Жестокий век.btnAutoFlip = js.Lib.document.getElementById("btnAutoFlip");
        RunTime.Жестокий век.btnDownload = js.Lib.document.getElementById("btnDownload");
        RunTime.Жестокий век.btnEmail = js.Lib.document.getElementById("btnEmail");
        RunTime.Жестокий век.btnSns = js.Lib.document.getElementById("btnSns");
        RunTime.Жестокий век.btnShowTxt = js.Lib.document.getElementById("btnShowTxt");
        RunTime.Жестокий век.imgLogo = js.Lib.document.getElementById("imgLogo");
        RunTime.Жестокий век.topBar = js.Lib.document.getElementById("topBar");
        RunTime.Жестокий век.topBarContent = js.Lib.document.getElementById("topBarContent");
        RunTime.Жестокий век.topFullTextContent = js.Lib.document.getElementById("topFullTextContent");
        RunTime.Жестокий век.bottomBar = js.Lib.document.getElementById("bottomBar");
        RunTime.Жестокий век.bottomBarBg = js.Lib.document.getElementById("bottomBarBg");
        RunTime.Жестокий век.bottomBarBg.style.opacity = RunTime.bottomBarAlpha;
        RunTime.Жестокий век.topMenuBar = js.Lib.document.getElementById("topMenuBar");
        RunTime.Жестокий век.topMenuBarBg = js.Lib.document.getElementById("topMenuBarBg");
        RunTime.Жестокий век.topMenuBarBg.style.opacity = RunTime.bottomBarAlpha;
        RunTime.Жестокий век.topBarContent.style.zIndex = 100;
        RunTime.Жестокий век.menuParent = js.Lib.document.getElementById("menuParent");
        RunTime.Жестокий век.maskPopup = js.Lib.document.getElementById("maskPopup");
        RunTime.Жестокий век.cvsSlideshow = js.Lib.document.getElementById("cvsSlideshow");
        RunTime.Жестокий век.cvsVideo = js.Lib.document.getElementById("cvsVideo");
        RunTime.Жестокий век.cvsOthers = js.Lib.document.getElementById("cvsOthers");
        RunTime.Жестокий век.cvsAudio = js.Lib.document.getElementById("cvsAudio");
        RunTime.Жестокий век.cvsLeftPageBgAudio = js.Lib.document.getElementById("cvsLeftPageBgAudio");
        RunTime.Жестокий век.cvsRightPageBgAudio = js.Lib.document.getElementById("cvsRightPageBgAudio");
        RunTime.Жестокий век.cvsYoutube = js.Lib.document.getElementById("cvsYoutube");
        RunTime.Жестокий век.btnZoom = js.Lib.document.getElementById("btnZoom");
        var left = (RunTime.clientWidth - 500) / 2 | 0;
        RunTime.Жестокий век.topBar.style.left = Std.string(left) + "px";
        var c = RunTime.Жестокий век.root;
        RunTime.Жестокий век.canvas = c;
        RunTime.Жестокий век.attachActions();
        ...
        RunTime.Жестокий век.cvsButton = cvsButton;
        ...
        RunTime.Жестокий век.cvsHighLight = cvsHighLight;
        ...
        RunTime.Жестокий век.cvsNote = cvsNote;
        ...
        RunTime.Жестокий век.cvsBookmark = cvsBookmark;
        cvsBookmark.width = RunTime.clientWidth;
        cvsBookmark.height = RunTime.clientHeight;
        RunTime.Жестокий век.zoom.style.width = RunTime.clientWidth + "px";
        RunTime.Жестокий век.zoom.style.height = RunTime.clientHeight + "px";
        RunTime.Жестокий век.afterInit();
        RunTime.Жестокий век.bookContext.ctx = RunTime.Жестокий век.getContext();
        RunTime.Жестокий век.bookContext.ctxButton = RunTime.Жестокий век.getButtonContext();
        RunTime.Жестокий век.bookContext.ctxHighLight = RunTime.Жестокий век.getHighLightContext();
        RunTime.Жестокий век.bookContext.ctxNote = RunTime.Жестокий век.getNoteContext();
        RunTime.Жестокий век.bookContext.ctxBookmark = RunTime.Жестокий век.getBookmarkContext();
...
RunTime.requestBookInfo = function() {
    ...
    function(data) {
        ...
        if (!RunTime.singlePage) RunTime.Жестокий век.requestMainAd();
        RunTime.hideLoadingLogo()
    })
}
RunTime.InputPwd=function(){RunTime.showPopupMaskLayer();RunTime.Жестокий век.cvsOthers.innerHTML=core.HtmlHelper.toInputPwdHtml()}
RunTime.InputUnlock=function(){RunTime.showPopupMaskLayer();RunTime.Жестокий век.cvsOthers.innerHTML=core.HtmlHelper.toInputUnlockPwdHtml()}
...
RunTime.tryUnlock = function(pwd) {
    ...
    if (encode == RunTime.book.password) {
        ...
        RunTime.Жестокий век.leftPageLock.style.display = "none";
        RunTime.Жестокий век.rightPageLock.style.display = "none";
        RunTime.Жестокий век.bookContext.render()
    } else js.Lib.window.alert(L.s("PasswordError"))
}
RunTime.afterRequestBookInfo=function(){RunTime.Жестокий век.cvsOthers.innerHTML="";RunTime.clearPopupContents();RunTime.requestPages();RunTime.useAnalyticsUA(RunTime.book.analyticsUA,RunTime.book.bookId)}
...
RunTime.requestSlideshow = function(onSuccess) {
    ...
    function(data) {
        ...
        if (RunTime.Жестокий век != null) {
            RunTime.Жестокий век.loadCtxSlideshow();
            RunTime.Жестокий век.bookContext.render()
        }
...
RunTime.requestHotlinks = function(onSuccess) {
    ...
    function(data) {
        ...
        if (RunTime.Жестокий век != null) {
            RunTime.Жестокий век.loadCtxHotlinks();
            RunTime.Жестокий век.bookContext.render()
        }
        if (onSuccess != null) onSuccess()
    })
...
RunTime.requestVideos = function(onSuccess) {
    ...
    function(data) {
        ...
        RunTime.loadVideos();
        if (RunTime.Жестокий век != null) {
            RunTime.Жестокий век.updateVideos();
            RunTime.Жестокий век.bookContext.render()
        }
        if (onSuccess != null) onSuccess()
    })
...
RunTime.reauestAudios = function(onSuccess) {
    ...
    function(data) {
        ...
        RunTime.loadAudios();
        if (RunTime.Жестокий век != null) RunTime.Жестокий век.updateAudios();
        if (onSuccess != null) onSuccess()
    })
}
RunTime.requestButtons=function(onSuccess){orc.utils.Util.request(RunTime.urlButtons,function(data){RunTime.buttonInfo=Xml.parse(data);RunTime.loadButtons();if(RunTime.Жестокий век!=null){RunTime.Жестокий век.loadCtxButtons();RunTime.Жестокий век.bookContext.render()}if(onSuccess!=null)onSuccess()})}
...
RunTime.reload=function(){js.Lib.window.location.href=RunTime.Жестокий век.getFullUrl()}
...
RunTime.loadBookInfo = function() {
    ...
    if (RunTime.book.logoUrl != null && RunTime.book.logoUrl != "") {
        ...
        if (!hideLogo) {
            RunTime.Жестокий век.imgLogo.style.display = "inline";
            var obj = RunTime.Жестокий век.imgLogo;
            obj.src = RunTime.book.logoUrl;
            RunTime.Жестокий век.imgLogo.onclick = RunTime.onLogoClick
        }
    }
    RunTime.Жестокий век.btnDownload.onclick = RunTime.onDownloadClick;
...
//      RunTime.book.menuAboutUsVisible = RunTime.getMenuVisible(leftMenuNode, "about")
    ...
    RunTime.setMenuVisible(RunTime.Жестокий век.btnContents, RunTime.book.menuTocVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnThumbs, RunTime.book.menuThumbsVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnSearch, RunTime.book.menuSearchVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnAutoFlip, RunTime.book.menuAutoFlipVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnShowTxt, RunTime.book.menuTxtVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnZoom, false);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnDownload, RunTime.book.menuDownloadVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnEmail, RunTime.book.menuEmailVisible);
    RunTime.setMenuVisible(RunTime.Жестокий век.btnSns, RunTime.book.menuSnsVisible);
    var menuCount = 0;
    ...
    if (hideIcon) {
        if (menuCount < 5) RunTime.setMenuVisible(RunTime.Жестокий век.btnMask, RunTime.book.menuHighlightVisible);
        if (RunTime.book.menuHighlightVisible) menuCount += 1;
        if (menuCount < 5) {
            RunTime.setMenuVisible(RunTime.Жестокий век.btnNote, RunTime.book.menuNoteVisible);
            menuCount += 1
        }
        if (RunTime.book.menuNoteVisible) menuCount += 1;
        if (menuCount < 5) {
            RunTime.setMenuVisible(RunTime.Жестокий век.btnBookMark, RunTime.book.menuBookmarkVisible);
            menuCount += 1
        }
    } else {
        RunTime.setMenuVisible(RunTime.Жестокий век.btnMask, RunTime.book.menuHighlightVisible);
        RunTime.setMenuVisible(RunTime.Жестокий век.btnNote, RunTime.book.menuNoteVisible);
        RunTime.setMenuVisible(RunTime.Жестокий век.btnBookMark, RunTime.book.menuBookmarkVisible)
    }
    RunTime.loadState()
}
RunTime.setMenuVisible=function(menu,visible){if(visible==true)menu.style.display="inline";else RunTime.Жестокий век.menuParent.removeChild(menu)}
...
RunTime.loadPageInfo = function() {
    ...
    RunTime.Жестокий век.setPageCount(RunTime.book.pages.length);
    RunTime.Жестокий век.setCurrentPage(RunTime.defaultPageNum + 1);
    RunTime.Жестокий век.loadPage(RunTime.defaultPageNum)
}
...
RunTime.getInputAndJumpToPage=function(){RunTime.Жестокий век.stopFlip();var t=RunTime.Жестокий век.tbPage;var val=t.value;val=StringTools.trim(val);var num=RunTime.Жестокий век.currentPageNum;if(val!="")num=Std.parseInt(val)-1;if(num<0)num=0;else if(num>RunTime.book.pages.length-1)num=RunTime.book.pages.length-1;RunTime.Жестокий век.tbPage.setAttribute("value",Std.string(num+1));RunTime.Жестокий век.turnToPage(num);RunTime.Жестокий век.tbPage.blur()}
RunTime.getPage = function(currentPageNum, pageOffset, useNewDrawParams) {
    ...
    if (RunTime.singlePage) {
        RunTime.Жестокий век.zoomLeftPage.width = page.drawParams.dw | 0;
        RunTime.Жестокий век.zoomLeftPage.height = page.drawParams.dh | 0;
        RunTime.Жестокий век.zoomLeftPage.style.left = Std.string(page.drawParams.dx) + "px";
        RunTime.Жестокий век.zoomLeftPage.style.top = Std.string(page.drawParams.dy) + "px";
        RunTime.Жестокий век.leftPageLock.style.width = (page.drawParams.dw | 0) + "px";
        RunTime.Жестокий век.leftPageLock.style.height = (page.drawParams.dh | 0) + "px";
        RunTime.Жестокий век.leftPageLock.style.left = Std.string(page.drawParams.dx) + "px";
        RunTime.Жестокий век.leftPageLock.style.top = Std.string(page.drawParams.dy) + "px";
        RunTime.Жестокий век.leftLockIcon.style.left = ((page.drawParams.dw - 128) / 2 | 0) + "px";
        RunTime.Жестокий век.leftLockIcon.style.top = ((page.drawParams.dh - 128) / 2 | 0) + "px"
    }
    return page
}
...
RunTime.saveCurrentPageNum = function() { RunTime.savePageNum(Std.string(RunTime.Жестокий век.getCurrentPageNum()));}
...
RunTime.clearPopupContents=function(){js.Lib.document.getElementById("maskPopup").style.display="none";js.Lib.document.getElementById("cvsOthers").innerHTML="";RunTime.Жестокий век.resetNoteButton();RunTime.Жестокий век.resetHighlightButton()}
...
RunTime.readLocalHighLights=function(){var highlights=new Array();var i=0;var _g1=0,_g=localStorage.length;while(_g1<_g){var i1=_g1++;var szKey=localStorage.key(i1);if(szKey.indexOf(RunTime.kvPrex)==0){if(szKey.indexOf("@$ht$@")!=-1){var highlight=new core.HighLight();highlight.fillData(szKey,localStorage.getItem(szKey));highlights.push(highlight);RunTime.book.highlights.push(highlight)}}}RunTime.highLights=highlights;if(RunTime.Жестокий век!=null){RunTime.Жестокий век.loadCtxHighLights();RunTime.Жестокий век.bookContext.render()}return highlights}
RunTime.updateHighLightNote=function(text){if(RunTime.currentHighLight!=null){RunTime.currentHighLight.updateText(text);RunTime.Жестокий век.resetHighlightButton()}}
RunTime.deleteHighLight=function(){if(RunTime.currentHighLight!=null){RunTime.currentHighLight.remove();HxOverrides.remove(RunTime.book.highlights,RunTime.currentHighLight);RunTime.currentHighLight=null;RunTime.Жестокий век.loadCtxHighLights();RunTime.Жестокий век.bookContext.render();RunTime.Жестокий век.resetHighlightButton()}}
RunTime.readLocalNotes=function(){var notes=new Array();var i=0;var _g1=0,_g=localStorage.length;while(_g1<_g){var i1=_g1++;var szKey=localStorage.key(i1);if(szKey.indexOf(RunTime.kvPrex)==0){if(szKey.indexOf("@$ni$@")!=-1){var note=new core.NoteIcon();note.fillData(szKey,localStorage.getItem(szKey));notes.push(note);RunTime.book.notes.push(note)}}}RunTime.notes=notes;if(RunTime.Жестокий век!=null){RunTime.Жестокий век.loadCtxNotes();RunTime.Жестокий век.bookContext.render()}return notes}
RunTime.updateNote=function(text){if(RunTime.currentNote!=null){RunTime.currentNote.updateText(text);RunTime.Жестокий век.resetNoteButton()}}
RunTime.deleteNote=function(){if(RunTime.currentNote!=null){RunTime.currentNote.remove();HxOverrides.remove(RunTime.book.notes,RunTime.currentNote);RunTime.currentNote=null;RunTime.Жестокий век.loadCtxNotes();RunTime.Жестокий век.bookContext.render();RunTime.Жестокий век.resetNoteButton()}}
...
core.ButtonInfo.prototype = {
    click: function(popupXOffset, popupYOffset) {
        ...
        case "":
            if (this.destination != null) {
                if (this.destination.indexOf("page:") == 0) {
                    ...
                    if (RunTime.Жестокий век != null) RunTime.Жестокий век.turnToPage(num - 1);
                    ...
                    if (fun == "content") RunTime.Жестокий век.onContentsClick(null);
                    else if (fun == "thumb") RunTime.Жестокий век.onThumbsClick(null);
                    else if (fun == "showtxt") RunTime.Жестокий век.onShowTxtClick(null);
                    else if (fun == "highlight") RunTime.Жестокий век.onButtonMaskClick(null);
                    else if (fun == "bookmark") RunTime.Жестокий век.onButtonBookmark(null);
                    else if (fun == "notes") RunTime.Жестокий век.onButtonNoteClick(null);
                    else if (fun == "autoflip") RunTime.Жестокий век.onAutoFlipClick(null);
                    else if (fun == "download") RunTime.onDownloadClick(null);
                    else if (fun == "fliptofront") RunTime.Жестокий век.turnToFirstPage(null);
                    else if (fun == "flipleft") RunTime.Жестокий век.turnToPrevPage(null);
                    else if (fun == "flipright") RunTime.Жестокий век.turnToNextPage(null);
                    else if (fun == "fliptoback") RunTime.Жестокий век.turnToLastPage(null)
                } else {
                    RunTime.logClickLink(this.destination);
        ...
        case "video":
            ...
            break;
        case "audio":
            RunTime.Жестокий век.showPopupAudio(this);
...
core.Page.prototype = {
    ...
    onLoadImage: function() {
        ...
        this.loaded = true;
        this.draw();
        if (RunTime.Жестокий век.currentPageNum == null || RunTime.Жестокий век.currentPageNum == this.num) {
            RunTime.Жестокий век.loadCtxHotlinks();
            RunTime.Жестокий век.bookContext.render()
        }
    },
...
core.PagePair = function(i) {
    ...
    if (i == 0) {
        ...
        RunTime.Жестокий век.zoomRightPage.width = this.rightPage.drawParams.dw | 0;
        RunTime.Жестокий век.zoomRightPage.height = this.rightPage.drawParams.dh | 0;
        RunTime.Жестокий век.zoomRightPage.style.left = Std.string(this.rightPage.drawParams.dx) + "px";
        RunTime.Жестокий век.zoomRightPage.style.top = Std.string(this.rightPage.drawParams.dy) + "px";
        RunTime.Жестокий век.rightPageLock.style.width = (this.rightPage.drawParams.dw | 0) + "px";
        RunTime.Жестокий век.rightPageLock.style.height = (this.rightPage.drawParams.dh | 0) + "px";
        RunTime.Жестокий век.rightPageLock.style.left = Std.string(this.rightPage.drawParams.dx) + "px";
        RunTime.Жестокий век.rightPageLock.style.top = Std.string(this.rightPage.drawParams.dy) + "px";
        RunTime.Жестокий век.rightLockIcon.style.left = ((this.rightPage.drawParams.dw - 128) / 2 | 0) + "px";
        RunTime.Жестокий век.rightLockIcon.style.top = ((this.rightPage.drawParams.dh - 128) / 2 | 0) + "px"
        ...
        RunTime.Жестокий век.zoomLeftPage.width = this.leftPage.drawParams.dw | 0;
        RunTime.Жестокий век.zoomLeftPage.height = this.leftPage.drawParams.dh | 0;
        RunTime.Жестокий век.zoomLeftPage.style.left = Std.string(this.leftPage.drawParams.dx) + "px";
        RunTime.Жестокий век.zoomLeftPage.style.top = Std.string(this.leftPage.drawParams.dy) + "px";
        RunTime.Жестокий век.leftPageLock.style.width = (this.leftPage.drawParams.dw | 0) + "px";
        RunTime.Жестокий век.leftPageLock.style.height = (this.leftPage.drawParams.dh | 0) + "px";
        RunTime.Жестокий век.leftPageLock.style.left = Std.string(this.leftPage.drawParams.dx) + "px";
        RunTime.Жестокий век.leftPageLock.style.top = Std.string(this.leftPage.drawParams.dy) + "px";
        RunTime.Жестокий век.leftLockIcon.style.left = ((this.leftPage.drawParams.dw - 128) / 2 | 0) + "px";
        RunTime.Жестокий век.leftLockIcon.style.top = ((this.leftPage.drawParams.dh - 128) / 2 | 0) + "px"
    } else {
        var right = i + 1 - (i + 1) % 2;
        var left = right - 1;
...
core.SlideshowInfo.prototype = {
    ...
    getDrawParams: function() {
        var dp = RunTime.getDrawParams(this.pageLayoutType);
        var ctx = RunTime.Жестокий век.bookContext;
